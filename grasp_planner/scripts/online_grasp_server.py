...
class grasping:
    ...
    def __init__(self):
        ...
        self.tfList = []        
        self.thetaList = numpy.linspace(-0.34906585, 0.34906585, num=10) # 0.174532925 = 10deg. SO range is from -10deg to 10deg using num=41 spacing        
    ...
    def compute_y_mid(self, miny, maxy): #miny maxy already given wrt to base
        y = (miny+maxy)/2
